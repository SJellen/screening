  ...
  const personFilmographyTile = (
    <div className="filmography-nav-container">
      <div className="filmography-nav">
        ...
        {sortedCastMovieArr &&
        sortedCastMovieArr.length > 0 &&
        sortedCastTvArr &&
        sortedCastTvArr.length > 0 ? (
          <a className="filmography-nav-type" href="#actor">
        ...
        {directorArr && directorArr.length > 0 ? (
          <a className="filmography-nav-type" href="#director">
            Director
          </a>
        ) : (
          ""
        ...
        {writingArr && writingArr.length > 0 ? (
          <a className="filmography-nav-type" href="#writer">
            Writer
          </a>
        ) : (
          ""
        ...
        {productionArr && productionArr.length > 0 ? (
          <a className="filmography-nav-type" href="#producer">
            Producer
          </a>
        ) : (
          ""
        ...
        {otherJobArr && otherJobArr.length > 0 ? (
          <a className="filmography-nav-type" href="#misc">
            Misc
          </a>
        ) : (
          ""
