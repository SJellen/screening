  ...
  return (
    <div className="watchlist-page-container">
      ...
      <h1 className="results-title">
        {userData.user && userData.user.displayName !== undefined
          ? `${userData.user.displayName}'s`
          : ""}{" "}
        Watchlist
      </h1>
      {watchListMovie.length > 0 ? (
        <div>
          ...
          <div className="slider-sub-container">{watchListMovieTile}</div>
        </div>
      ) : (
        ""
      )}
      {watchListTv && watchListTv.length > 0 ? (
        <div>
          ...
          <div className="slider-sub-container">{watchListTvTile}</div>
        </div>
      ) : (
        ""
      )}
