...
function MovieSimilar() {
    ...
    const {posterPath, handleMovieClick,movieSimilarArr, handleRibbon, ribbonToggle}  = useContext(Context)
    ...
    { ribbonToggle === movie.id ?
         <i className="im im-bookmark im-bookmark-slider" onClick={() => handleRibbon(index, movieSimilarArr)} style={{color: "#E1B517"}}></i> :
         <i className="im im-bookmark im-bookmark-slider" onClick={() => handleRibbon(index, movieSimilarArr)} style={{color: ""}}></i>
       }
        </span> 
