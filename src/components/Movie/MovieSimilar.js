...
function MovieSimilar() {
    ...
    const {posterPath, handleMovieClick,movieSimilarArr, handleRibbonMovie, watchListMovie, ratingTruncate, watchListMovieIds, setWatchListMovie}  = useContext(Context)
