...
function MovieRecommendations() {
    ...
    const {posterPath, handleMovieClick, movieRecommendationArr, handleRibbon, ribbonToggle}  = useContext(Context)
    ...
    { ribbonToggle === movie.id ?
         <i className="im im-bookmark im-bookmark-slider" onClick={() => handleRibbon(index, movieRecommendationArr)} style={{color: "#E1B517"}}></i> :
         <i className="im im-bookmark im-bookmark-slider" onClick={() => handleRibbon(index, movieRecommendationArr)} style={{color: ""}}></i>
       }
        </span> 
