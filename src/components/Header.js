    ...
    <div className="header">
      <div className="header-left-container">
        <Link to="/" className="header-title-link">
          <span className="title" onClick={handleLogoClick}>
            Screening
          </span>
        </Link>
      ...
      <div className="header-watchlist-box-container">
        <Link to="/watchList/" style={{ textDecoration: "none" }}>
          <div className="header-right-container">
            <BookmarkIcon
              className="im im-bookmark im-bookmark-header"
              fontSize="large"
              style={{ color: watchListTotal > 0 ? "#E1B517" : "" }}
            />
            <span className="header-watchlist">Watchlist</span>
          </div>
        </Link>
      </div>
      {userData.user ? (
        <Link to="/" style={{ textDecoration: "none" }}>
          <div className="header-right-container">
            <span className="header-signIn" onClick={handleSignOut}>
              Log Out
            </span>
          </div>
        </Link>
        ...
        <Link to="/signIn/" style={{ textDecoration: "none" }}>
          <div className="header-right-container">
            <span className="header-signIn" onClick={handleSignIn}>
              Sign In
            </span>
          </div>
        </Link>
