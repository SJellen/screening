...
function Header() {
    ...
    const {fetchSearchResults, setSearchTerm, setMediaType, handleLogoClick, watchListTv, watchListMovie}  = useContext(Context)
            ...
            <Link to="/menuPage/" style={{textDecoration: "none"}}>
                ...
                <div className="header-watchlist-box-container">
                   <Link to="/watchList/" style={{textDecoration: "none"}}>
                    ...
                    <i className="im im-bookmark im-bookmark-header"></i><span className="header-watchlist">Watchlist</span></div>
                </Link> 
                </div>
