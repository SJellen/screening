...
function Popular() {
    ...
    return (
        ...
        <span className="slider-label">Popular: Movies <Link to={"/menuLinkPage/popularMovies/"} style={{textDecoration: "none"}} onClick={handleMenuPopularClick} ><svg xmlns="http://www.w3.org/2000/svg" width="15" height="24" viewBox="0 0 24 24" fill="#E1B517" className="link-arrow"><path d="M5 3l3.057-3 11.943 12-11.943 12-3.057-3 9-9z"/></svg></Link></span>
        <div className="slider-sub-container">
            {popularMoviesTile}
        </div>
        <span className="slider-label">Popular: TV <Link to={"/menuLinkPage/popularTv/"} style={{textDecoration: "none"}} onClick={handleMenuPopularTvClick} ><svg xmlns="http://www.w3.org/2000/svg" width="15" height="24" viewBox="0 0 24 24" fill="#E1B517" className="link-arrow"><path d="M5 3l3.057-3 11.943 12-11.943 12-3.057-3 9-9z"/></svg></Link></span>
        <div className="slider-sub-container">
            {popularTvTile}
        </div>
